...
import org.dromara.raincat.core.concurrent.task.AsyncCall;
        ...
        try {
            switch (actionEnum) {
                ...
                case GET_TRANSACTION_GROUP_STATUS:
                    ...
                    blockTask.setAsyncCall(new AsyncCall() {
                        @Override
                        public Object callBack(Object... objects) throws Throwable {
                            return txTransactionGroup.getStatus();
                        }
                    });
                    blockTask.signal();
                    break;
